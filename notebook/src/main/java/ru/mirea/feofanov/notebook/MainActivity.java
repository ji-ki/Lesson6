package ru.mirea.feofanov.notebook;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        citata=findViewById(R.id.citata);
    }
    public	void	writeFileToExternalStorage() {
        ...
        try {
            ...
            output.write(citata.getText().toString());
    ...
    public void saveCitata(View view) {
        writeFileToExternalStorage();
    }

    public void readCitata(View view) {
